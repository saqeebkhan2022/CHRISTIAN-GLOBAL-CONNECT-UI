      ...
      >
        ...
        >
          ...
          <nav className="hidden md:flex items-center gap-8 text-sm font-medium">
            ...
            <div
              className="relative"
              onMouseEnter={() => setSpiritualOpen(true)}
              onMouseLeave={() => setSpiritualOpen(false)}
            >
              ...
              {spiritualOpen && (
                <div className="absolute top-full left-0 mt-3 w-48 bg-card border border-border rounded-xl shadow-lg overflow-hidden">
                  <Link
                    to="/bible"
                  ...
                  {/* Future links */}
                  {/* <Link to="/devotion" className="block px-4 py-3 hover:bg-muted">
                    Daily Devotion
                  </Link> */}
                </div>
              )}
